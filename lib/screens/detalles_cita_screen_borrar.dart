...
class DetallesCitaScreenBorrar extends StatefulWidget {
  final String emailUsuario;
  final Map<String, dynamic> reserva;
  const DetallesCitaScreenBorrar(
      {Key? key, required this.reserva, required this.emailUsuario})
      : super(key: key);

  @override
  State<DetallesCitaScreenBorrar> createState() =>
      _DetallesCitaScreenBorrarState();
}

class _DetallesCitaScreenBorrarState extends State<DetallesCitaScreenBorrar> {
