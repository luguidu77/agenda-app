  ...
  ListView newMethod(citas) {
    return ListView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        var horainiciocita = DateTime.parse(citas[index]['horaInicio']);
        ...
        if (widget.iniciadaSesionUsuario) {
          compruebafechaDisponible = citas[index]['idServicio'] != null;
        } else {
          compruebafechaDisponible = citas[index]['idServicio'] != 999;
        }
          ...
          children: [
            Dismissible(
              ...
              child: GestureDetector(
                ...
                child: _tarjetasCitas(compruebafechaDisponible, citas, index,
                    horaInicio, estiloHorario, horaFinal),
              ),
            ),
          ],
        );
